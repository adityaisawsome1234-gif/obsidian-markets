...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[55rem] md:h-[70rem] flex items-center justify-center relative p-2 md:p-20 pt-24"
      ref={containerRef}
    >
...
export const Card = ({ rotate, scale, children }: { rotate: MotionValue<number>; scale: MotionValue<number>; translate: MotionValue<number>; children: React.ReactNode }) => (
  ...
  >
    <div className="h-full w-full overflow-hidden rounded-2xl bg-[#0b0b0f] md:rounded-2xl md:p-4">{children}</div>
  </motion.div>
);
